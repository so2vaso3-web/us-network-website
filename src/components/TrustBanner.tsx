        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-2">
                <i className="fas fa-lock text-blue-400 text-lg"></i>
                <span className="font-semibold">PCI Compliant</span>
              </div>
              <div className="flex items-center gap-2">
                <i className="fas fa-certificate text-yellow-400 text-lg"></i>
                <span className="font-semibold">Certified Partners</span>
              </div>
              <div className="flex items-center gap-2">
                <i className="fas fa-award text-purple-400 text-lg"></i>
            ...
            <button
              onClick={handleClose}
              className="text-gray-400 hover:text-white transition-colors w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/10 flex-shrink-0"
