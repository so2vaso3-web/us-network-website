      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-md rounded-2xl p-8 border border-white/10 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-blue-500/20 group relative overflow-hidden h-full flex flex-col"
            >
              {/* Hover effect background */}
              <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>
              
              <div className="relative z-10">
                <div className={`w-20 h-20 rounded-2xl ${feature.iconBg} border-2 border-white/20 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:border-blue-500/50 transition-all duration-300 shadow-xl group-hover:shadow-blue-500/30 relative overflow-hidden`}>
                  ...
                  <i className={`${feature.icon} text-3xl text-white relative z-10 group-hover:scale-110 transition-transform duration-300`}></i>
                </div>
                <h3 className="text-xl font-bold mb-3 text-white group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-500 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                  {feature.title}
                </h3>
        ...
        <div className="mt-12 pt-10 border-t border-white/10">
          <div className="grid md:grid-cols-4 gap-6 text-center">
            <div className="p-6 bg-gradient-to-br from-blue-500/10 to-transparent rounded-xl border border-blue-500/20 relative overflow-visible group hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
              <div className="absolute top-2 right-2 cursor-pointer group/tick">
                <div className="relative inline-block">
                  ...
                  <i className="fas fa-check-circle text-green-400 text-lg group-hover/tick:scale-110 transition-all duration-300 relative" style={{ 
              ...
              <h4 className="font-bold text-lg mb-2">Certified Partners</h4>
              <p className="text-gray-400 text-sm">
                Authorized reseller for all major US carriers
              </p>
            </div>
            <div className="p-6 bg-gradient-to-br from-cyan-500/10 to-transparent rounded-xl border border-cyan-500/20 relative overflow-visible group hover:border-cyan-500/50 transition-all duration-300 hover:scale-105">
              <div className="absolute top-2 right-2 cursor-pointer group/tick">
                <div className="relative inline-block">
                  <div className="absolute inset-0 bg-green-400 rounded-full opacity-30 animate-ping -inset-1 scale-150"></div>
                  <i className="fas fa-check-circle text-green-400 text-lg group-hover/tick:scale-110 transition-all duration-300 relative" style={{ 
              ...
              <i className="fas fa-certificate text-4xl text-cyan-400 mb-4"></i>
              <h4 className="font-bold text-lg mb-2">Authorized Reseller</h4>
              <p className="text-gray-400 text-sm">
                Officially authorized to sell plans from major carriers
              </p>
            </div>
            <div className="p-6 bg-gradient-to-br from-purple-500/10 to-transparent rounded-xl border border-purple-500/20 relative overflow-visible group hover:border-purple-500/50 transition-all duration-300 hover:scale-105">
              <div className="absolute top-2 right-2 cursor-pointer group/tick">
                <div className="relative inline-block">
                  <div className="absolute inset-0 bg-green-400 rounded-full opacity-30 animate-ping -inset-1 scale-150"></div>
                  <i className="fas fa-check-circle text-green-400 text-lg group-hover/tick:scale-110 transition-all duration-300 relative" style={{ 
              ...
              <h4 className="font-bold text-lg mb-2">Secure Transactions</h4>
              <p className="text-gray-400 text-sm">
                PCI DSS compliant payment processing
              </p>
            </div>
            <div className="p-6 bg-gradient-to-br from-green-500/10 to-transparent rounded-xl border border-green-500/20 relative overflow-visible group hover:border-green-500/50 transition-all duration-300 hover:scale-105">
              <div className="absolute top-2 right-2 cursor-pointer group/tick">
                <div className="relative inline-block">
                  <div className="absolute inset-0 bg-green-400 rounded-full opacity-30 animate-ping -inset-1 scale-150"></div>
                  <i className="fas fa-check-circle text-green-400 text-lg group-hover/tick:scale-110 transition-all duration-300 relative" style={{ 
              ...
              <i className="fas fa-handshake text-4xl text-green-400 mb-4"></i>
